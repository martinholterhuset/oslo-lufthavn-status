...
2. **Innstilte flyvninger** – liste over hver enkelt innstilte flyvning i dag (tid, retning, flight, selskap, flyplass)
...
2. **Innstilte flyvninger** – legg inn en midlertidig CSV manuelt (kolonner: `Dato,Klokkeslett,Retning,Flight,Selskap,Flyplass`, der `Dato` er `dd.mm.åå` f.eks. `21.08.26`, og `Klokkeslett` er `tt:mm`)
