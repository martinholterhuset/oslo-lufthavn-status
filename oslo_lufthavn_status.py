...
def main():
    ...
    updated_header = f"<b>Sist oppdatert klokka {updated_at_dotted} (norsk tid)</b><br>"
    ...
    if DATAWRAPPER_CHART_ID_CANCELLED:
        ...
        push_to_datawrapper(DATAWRAPPER_CHART_ID_CANCELLED, cancelled_csv, updated_header.removesuffix("<br>"))
